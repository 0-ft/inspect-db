...
def test_insert_log(raw_db: EvalDB, sample_eval_log: EvalLog):
    ...
    log_uuid = raw_db.ingest_log(sample_eval_log)
...
def test_get_db_samples(raw_db: EvalDB, sample_eval_logs: list[EvalLog]):
    ...
    # First insert logs
    log_uuids = [raw_db.ingest_log(log) for log in sample_eval_logs]
...
def test_stats(raw_db: EvalDB, sample_eval_log: EvalLog):
    ...
    raw_db.ingest_log(sample_eval_log)
    stats = raw_db.stats()
...
def test_get_inspect_samples(raw_db: EvalDB, sample_eval_log: EvalLog):
    """Test retrieving samples as inspect EvalSample objects."""
    # First insert a log
    log_uuid = raw_db.ingest_log(sample_eval_log)
