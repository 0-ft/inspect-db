...
def sample_eval_log_path() -> Path:
    ...
    return Path(__file__).parent / "sample_logs" / "2025-03-28T23-01-38+00-00_agentharm_Nxk5Uxvp8fxJ6ecWsUah43.eval"
...
def mock_progress_listener(mocker: MockerFixture):
    ...
    mock.on_file_started.return_value = "mock_file_id"  # Return a consistent ID for testing
